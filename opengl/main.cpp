...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            glBindVertexArray(vaoIds[i]); // seeing as we only have a single VAO there's no need to bind it every time, but we'll do so to keep things a bit more organized
